...
Coverage: multi-group success and invalid pair rejection, rollback, card values, foot continuation vs next-turn pickup, hidden cards, seven-card pickup with immediate meld, four rounds, chat preservation, nine bot simulations at three difficulties, UI staging after rejected requests, and accessibility suite.
