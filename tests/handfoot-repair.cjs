...
(async()=>{
 ...
 const st=c.hfInit([1,2],19);st.hasDrawn=true;st.hands[1]=[1,2,3].map(id=>({id,rank:'3',suit:'♠'}));assert.throws(()=>c.hfMove(st,[1,2],0,{action:'meld',rank:'3',cardIds:[1,2,3]}),/Threes/);
