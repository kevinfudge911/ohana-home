...
picker.querySelector('select').onchange=async e=>{
 ...
 else previewGame={...previewGame,type,name:'Hand & Foot',state:{hands:{1:[{id:1,rank:'K',suit:'♥'},{id:2,rank:'K',suit:'♣'},{id:3,rank:'K',suit:'♦'},...['A','A','A','10','10','10','8','7','6','4','J'].map((rank,i)=>({id:i+4,rank,suit:['♥','♣','♦','♠'][i%4]}))],2:11},feet:{1:11,2:11},inFoot:{},melds:{1:[],2:[{rank:'Q',cards:Array.from({length:7},(_,i)=>({id:100+i,rank:'Q',suit:['♥','♣','♦','♠'][i%4]}))},{rank:'4',cards:[{id:110,rank:'4',suit:'♣'},{id:111,rank:'4',suit:'♥'},{id:112,rank:'2',suit:'♦'}]}]},red3s:{1:[],2:[{id:113,rank:'3',suit:'♥'}]},scores:{1:0,2:0},drawPile:80,discardPile:[{rank:'6',suit:'♥'}],discardCount:3,hasDrawn:true,chat:[]}};
